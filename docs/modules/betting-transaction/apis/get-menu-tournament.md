---
id: get-menu-tournament
type: api
title: 获取联赛列表
status: completed
createdAt: '2025-12-07'
updatedAt: '2025-12-07'
description: '根据体育项目和赛区获取联赛列表，支持分页。'
owner: 'Manus AI'
tags: ['导航', '菜单', '联赛']
version: '1.0'
apiType: REST
endpoint: '/v1/menu/tournament'
method: 'GET'
---

# GET /v1/menu/tournament 接口文档
...
```bash
curl -X GET \
  '/v1/menu/tournament?sport_id=<value>&cate_id=<value>' \
...
```javascript
const response = await fetch('/v1/menu/tournament?sport_id=value&cate_id=value', {
  method: 'GET',
  headers: {
