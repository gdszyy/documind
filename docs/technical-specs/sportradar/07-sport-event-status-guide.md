...
![比赛生命周期图](05_match_lifecycle.png)


### 2.1 状态流转图

比赛状态遵循特定的流转规则。下图详细展示了所有12种状态之间的主要转换路径：

![比赛状态流转图](01_state_transition.png)
...
![AMQP vs API 对比图](02_amqp_vs_api.png)
...
![元素结构图](06_element_structure.png)
...
![数据获取流程图](03_data_retrieval_flow.png)
...
下图展示了在客户端应用程序中处理不同`sport_event_status`时建议的决策流程，以确保系统的健壮性和用户体验的流畅性。

![状态处理决策树](04_status_decision_tree.png)
