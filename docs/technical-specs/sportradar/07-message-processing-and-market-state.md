...
> **【图表占位符 #1】消息处理流程图 (message_processing_flow.png)**
> 
> 该图应放在本位置，展示：
...
> **【图表占位符 #2】投注可用性层级图 (betting_availability_hierarchy.png)**
> 
> 该图应放在本位置，展示：
> - 四层检查机制的决策树
> - 系统连接检查
...
> **【图表占位符 #3】Market 状态转换图 (market_state_diagram.png)**
> 
> 该图应放在本位置，展示：
> - 6 种 Market 状态的完整转换图
...
> **【图表占位符 #4】进球处理时序图 (goal_handling_sequence.png)**
> 
> 该图应放在本位置，展示：
> - 进球发生时的 Market 状态变化
> - Suspended 状态的持续时间
...
> **【图表占位符 #5】生产者交接时序图 (handover_sequence.png)**
> 
> 该图应放在本位置，展示：
> - Prematch 生产者的最终消息
...
> **【图表占位符 #6】赛事生命周期图 (event_lifecycle.png)**
> 
> 该图应放在本位置，展示：
> - 赛事的完整生命周期阶段
> - 每个阶段的时间范围
